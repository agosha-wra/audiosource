...
import { getAlbum, deleteAlbum } from '../api';
...
export default function AlbumModal({ albumId, onClose, onDeleted }: AlbumModalProps) {
              ...
              <div className="album-header-row">
                ...
                {album.is_owned && (
                  <div className="album-header-actions">
                    ...
                    <button 
                      className={`delete-album-btn ${confirmDelete ? 'confirm' : ''}`}
